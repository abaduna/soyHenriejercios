...
if (arguments.length===0) {
  ...
  for (let index = 0; index < array.length; index++) {
   acoumulador = acoumulador*arguments[i]
...
function mesesDelAño(array) {
  ...
  for (let index = 0; index < array.length; index++) {
    if (array[index] ==="Enero"|| array[index] ==="Marzo"|| array[index] ==="Noviembre" ) {
     return nuevoAray.push(array[index]) 
    }else{
...
function mayorACien(array) {
  //La función recibe un array con enteros entre 0 y 200. Recorrer el array 
  //y guardar en un nuevo array sólo los
  //valores mayores a 100 (no incluye el 100). Finalmente devolver el nuevo array.
  // Tu código:
  arrayNuevo2 = []
  for (let index = 0; index < array.length; index++) {
   if (array[index] > 100) {
    arrayNuevo2.push(array[index])
   }
